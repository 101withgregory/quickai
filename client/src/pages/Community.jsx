...
function Community() {
  ...
  return !loading ?  (
    ...
    <div className=' flex items-center justify-center h-full'><span className='w-10 h-10 animate-spin border-t-transparent border-3 border-primary my-1 rounded-full'></span></div>
  )
}
